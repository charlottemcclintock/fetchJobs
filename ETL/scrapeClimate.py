...
class scrapeJobs():
    ...
    def get_jobs(self):
        ...
        driver.get('https://climatebase.org/jobs?l=&q=Data&job_types=Full+time+role&p=1')
    ...
    def dedupe(self): 
        ...
        WHERE fetch_date = (SELECT MAX(fetch_date) FROM datajobs WHERE source = 'ClimateBase')
